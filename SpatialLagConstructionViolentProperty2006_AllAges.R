...
# Shapefile                                               #
###########################################################
SHAPEFILEFOLDER<- "G:/MSC/PROJECTS/SocialInteractions/RESTAT_BUILD/SourceData/PC4/"
SHAPEFILENAME<-"nlp4_r07.shp"

###########################################################
# Datafile                                                #
###########################################################
DATAFILEFOLDER<- "G:/MSC/PROJECTS/SocialInteractions/RESTAT_BUILD/WorkData/"
DATAFILENAME<-"logit_pc4anycrime2006_AllAges.dta"
...
write.dta(as.data.frame(PC4Polygons@data) ,file=paste(DATAFILEFOLDER,  "Laggedpc4delinquents2006_AllAges.dta", convert.factors="numeric")
