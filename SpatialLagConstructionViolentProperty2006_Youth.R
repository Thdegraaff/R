...
DATAFILENAME<-"logit_pc4anycrime2006_Youth.dta"
...
write.dta(as.data.frame(PC4Polygons@data) ,file=paste(DATAFILEFOLDER,  "Laggedpc4delinquents2006_Youth.dta", convert.factors="numeric")
